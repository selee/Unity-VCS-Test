...
function Awake () {		
	...
	//take this out because networking breaks it.
	...
	#else
		if (cursorPrefab) {
			if((Network.peerType != NetworkPeerType.Client && Network.peerType != NetworkPeerType.Server) || !GetComponent("NetworkView") || (GetComponent("NetworkView") as NetworkView).isMine){
